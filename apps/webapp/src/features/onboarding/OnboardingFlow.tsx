    ...
    <main className="mx-auto flex w-full max-w-2xl flex-col gap-4">
      <section className="rounded-2xl border border-[rgb(var(--app-border))] bg-[rgb(var(--app-surface))] p-4 shadow-sm">
        <p className="m-0 text-xs uppercase tracking-wide text-[rgb(var(--app-muted))]">
          {t('onboarding.eyebrow', { current: step + 1, total: 3 })}
        </p>
      ...
      <section className="rounded-2xl border border-[rgb(var(--app-border))] bg-[rgb(var(--app-surface))] p-4 shadow-sm">
          ...
          <div className="grid gap-4">
            ...
            <div className="grid gap-2">
              {(['disclaimer', 'terms', 'privacy'] as const).map((key) => (
                <label
                  key={key}
                  className="flex items-start gap-3 rounded-xl border border-[rgb(var(--app-border))] bg-[rgb(var(--app-bg))] p-3 text-sm text-[rgb(var(--app-text))]"
                >
                  <input
                    type="checkbox"
        ...
        <div className="mt-5 flex gap-2">
          <button
            ...
            className="min-h-11 flex-1 rounded-xl border border-[rgb(var(--app-border))] px-4 text-sm font-semibold text-[rgb(var(--app-text))] disabled:opacity-50"
          >
            {t('onboarding.back')}
          </button>
          <button
            ...
            className="min-h-11 flex-1 rounded-xl bg-[rgb(var(--app-primary))] px-4 text-sm font-semibold text-white disabled:opacity-50"
          >
